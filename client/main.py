...
""", "center"))
    ...
    def get_server(self):
        server_ip = console.input("[b]Insert server address[/b] :laptop_computer: : ")

        server_port = int(console.input("[b]Insert server port[/b] : "))

        # If server_ip == "local"... change server_ip to 127.0.0.1
        if server_ip == "local" or server_ip == "localhost" or server_ip == "::1":
                server_ip = "127.0.0.1"
